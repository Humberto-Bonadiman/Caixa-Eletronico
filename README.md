# Boas vindas ao repositório do projeto Caixa Eletrônico!

---

## Descrição do projeto

Neste projeto eu fui responsável por desenvolver uma aplicação de Caixa Eletrônico onde havia que implementar as classes para o caixa eletrônico, o banco, a conta, a pessoa cliente e a Transação. Também fui responsável por implementar os testes que testariam essa classes.
...
```javascript
git clone git@github.com:Humberto-Bonadiman/Caixa-Eletronico.git
```
