...
public class CaixaEletronico {
  ...
  public static void main(String[] args) {
    ...
    PessoaCliente pessoaCliente1 = banco.adicionarPessoaCliente(
        "Alexiania Pereira", "842.074.410-77", "1234"); 
    ...
    PessoaCliente pessoaCliente2 = banco.adicionarPessoaCliente(
        "Abadiania Silva", "848.725.510-87", "1234");
      ...
      if (pessoaClienteAutenticada == null) {
        ...
        do {
          ...
          if (op == 1) {
            ...
            do {
              System.out.printf(
                  "Entre com a quantia a ser sacada (máximo R$%.02f): R$ ",
                  saldoConta
              );
            ...
            do {
               ...
               */
              String mensagem = "Entre com a quantia para ser transferida (máximo R$%.02f): R$ ";
              System.out.printf(mensagem, saldoConta);
              quantia = sc.nextDouble();
